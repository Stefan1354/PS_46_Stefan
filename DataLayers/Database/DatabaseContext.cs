...
namespace DataLayers.Database
{
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var user1 = new DatabaseUser("Ivan", "132142", UserRolesEnum.PROFESSOR, "121221120", "kristiqn@abv.bg", 2, DateTime.Now.AddYears(8));
            var user2 = new DatabaseUser("Stoyan", "321331", UserRolesEnum.ADMIN, "123221011", "georgi@gmail.com", 3, DateTime.Now.AddYears(5));
